...
const User = require("../models/User.js"); //User is a model which is used to store data in database
const { body, validationResult } = require("express-validator");
const JWT_SECRET = "LoYaltI@MeThOdS";
    ...
    try {
      ...
      if (user) {
        ...
        return res
          ...
          .json({
            success,
            error: "sorry a user with this mail is already exit",
          });
      }
